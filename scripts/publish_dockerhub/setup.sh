...
S3_SECRET_KEY_VALUE="$(ask_secret_with_existing "S3_SECRET_KEY" "$(random_alnum 48)" "${EXISTING_S3_SECRET_KEY}")"
JWT_SECRET_VALUE="$(ask_secret_with_existing "JWT_SECRET" "$(random_alnum 64)" "${EXISTING_JWT_SECRET}")"
ADMIN_API_TOKEN_VALUE="$(ask_secret_with_existing "ADMIN_API_TOKEN" "$(random_alnum 64)" "${EXISTING_ADMIN_API_TOKEN}")"

printf -v POSTGRES_PASSWORD '%s' "${POSTGRES_PASSWORD_VALUE}"
printf -v S3_ACCESS_KEY '%s' "${S3_ACCESS_KEY_VALUE}"
printf -v S3_SECRET_KEY '%s' "${S3_SECRET_KEY_VALUE}"
printf -v JWT_SECRET '%s' "${JWT_SECRET_VALUE}"
printf -v ADMIN_API_TOKEN '%s' "${ADMIN_API_TOKEN_VALUE}"
